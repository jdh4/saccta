...
def main():
    ...
    with open("large_cluster_users_2023", "r") as fo:
        lines = fo.readlines()
    ...
    for netid in netids:
        ...
        # della is an arbitrary choice in next line if user has one sponsor
        if d["della"]:
            sponsors.append(d["della"])
    print(sorted(set(sponsors)))
    print(len(set(sponsors)))

    # if a sponsor is not found then search for it manually on tiger:
    # /home/jdh4/bin/monthly_sponsor_reports/archive
